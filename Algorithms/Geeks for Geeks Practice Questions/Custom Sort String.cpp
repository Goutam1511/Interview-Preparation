...
Solution : Count the frequencies of character in the main string and then traverse the order string and add the occurence of the 
characters of the main string to the result accordingly.
*/
